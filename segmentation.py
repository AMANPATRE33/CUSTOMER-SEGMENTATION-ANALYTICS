...
# Typography and Metric Component CSS Injections (Clean & High-Contrast)
st.markdown("""
    <style>
...
persona_map = {
    0: {
        ...
        "badge": "💎 High-Yield Corporate Asset Class",
    ...
    1: {
        ...
        "badge": "⚠️ High-Probability Churn Warning Class",
...
# ==========================================
# Left Sidebar Control Panel - Using clean native typography for accessibility
with st.sidebar:
    st.markdown("## **Control Hub**")
    st.caption("Engine Status: Ready (K=6)")
    st.markdown("---")
...
# Central Main Panel Analytics Canvas Layout
...
# ==========================================
if predict_btn:
    # Compile entries ensuring rigorous feature sequence shape alignment
    ...
    # Mathematical Model Inference Calculation
    ...
    # Render Interactive Metrics Layout
    ...
    # Fully Styled Contextual HTML Insight Block
    st.markdown(f"""
        <div style="background-color: {allocated_profile['color']}08; 
                    padding: 2.2rem; 
                    border-radius: 14px; 
                    border: 1px solid {allocated_profile['color']}25;
                    border-left: 7px solid {allocated_profile['color']}; 
                    margin-top: 1.8rem;">
            <h2 style="margin-top:0; color: {allocated_profile['color']}; font-weight:700; font-size:1.6rem; letter-spacing:-0.03em;">
                {allocated_profile['name']}
            </h2>
            <p style="font-size: 1.05rem; color: #1F2937; line-height: 1.65; margin-top:0.8rem; margin-bottom:1.5rem;">
                <strong>Statistical Persona Profile:</strong> {allocated_profile['desc']}
            </p>
            <div style="background-color: white; 
                        padding: 1.25rem 1.5rem; 
                        border-radius: 8px; 
                        border: 1px solid {allocated_profile['color']}15;
                        box-shadow: 0 1px 2px 0 rgba(0,0,0,0.02);">
                <p style="font-size: 1.05rem; color: #111827; margin-bottom: 0; line-height:1.6;">
                    <span style="color: {allocated_profile['color']}; font-weight: 700; font-size: 0.9rem; text-transform: uppercase; letter-spacing: 0.05em; display: block; margin-bottom: 0.25rem;">
    ...
    st.info("📊 Operational pipeline is idle. Adjust parameters in the left control hub sidebar and trigger the analytical execution mapping button above.")
